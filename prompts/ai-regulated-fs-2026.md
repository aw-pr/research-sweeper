...
Tip: This sweep is feeding a long-form post, so synthesis should be usable as raw material for a 1,500-2,500 word piece, not just a regulator briefing. The author has no prior position on the Mills Review and wants both background and a critical assessment.
